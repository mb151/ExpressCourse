        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.container2}>
                    ...
                    <Text style={styles.text3}>0630511280</Text>
                </View>
                <View style={styles.container2}>
                    <Image style={styles.ImageStyle} source={require('../icons/mail.png')}/>
                    <Text style={{color:'black', fontSize:20}}>elamineelbachir@gmail.com</Text>
                </View>
                <View style={styles.container2}>
                    <Image style={styles.ImageStyle} source={require('../icons/github.png')}/>
                    <Text style={styles.text3}>https://github.com/mb151</Text>
                </View>
            </View>
        );
    }
